...
CREATE TABLE atividades (
    ...
    matéria VARCHAR(50) NOT NULL,
    data DATE NOT NULL,
    professor VARCHAR(10) UNIQUE NOT NULL,
    status VARCHAR(20) NOT NULL CHECK (status IN ('a fazer', 'entregue', 'devolvida'))
);
```
...
```
INSERT INTO atividades (nome, matéria, data, professor, status) VALUES
('Toyotta Corolla', 'Linguagens', '2024-11-24', 'Natali', 'devolvida'),
('SA', 'Banco de Dados', '2024-11-24', 'Senna', 'a fazer'),
('Portfólio', 'MTM', '2024-11-24', 'Wagner', 'entregue');
